...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('src/img/user1-128x128.jpg') }}" alt="User Avatar"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('src/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('src/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
    ...
    <!-- ChartJS -->
    <script src="{{ asset('src/js/chartjs/Chart.min.js') }}"></script>
    <!-- Sparkline -->
    <script src="{{ asset('src/js/sparkline/sparkline.js') }}"></script>
    <!-- JQVMap -->
    ...
    <script src="{{ asset('src/js/daterangepicker/daterangepicker.js') }}"></script>
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('src/js/tempusdominus/tempusdominus-bootstrap-4.min.js') }}"></script>
    <!-- Summernote -->
    <script src="{{ asset('src/js/summernote/summernote-bs4.min.js') }}"></script>
    <!-- overlayScrollbars -->
    <script src="{{ asset('src/js/overlayScrollbars/jquery.overlayScrollbars.min.js') }}"></script>
    <!-- AdminLTE App -->
